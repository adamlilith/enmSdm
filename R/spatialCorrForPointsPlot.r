...
#' @param rescale Numeric, value by which to multiple distances. Typically if distances are in meters, but it is visually more appealing to display them in kilometers, so in that case \code{rescale} should equal 0.001. Default is 1 (no re-scaling).
...
spatialCorrForPointsPlot <- function(
	...
	# plot
	plot(midDists, midDists, ylim=c(0, ymax), ylab='Proportion', col='white', ...)
	graphics::polygon(
