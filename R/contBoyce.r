...
#' @param autoWindow Logical. If \code{FALSE} calculate bin boundaries starting at 0 and ending at 1 (default). If \code{TRUE} then calculate bin boundaries starting at mininum predicted value and ending at maximum predicted value.
...
#' @seealso \code{\link[stats]{cor}}, \code{\link{Fpb}}, \code{\link{aucWeighted}}
#' @examples
#' set.seed(123)
#' pres <- sqrt(runif(100))
#' bg <- runif(1000)
