...
#'
#' @description This function returns the area of a SpatialPolygon or SpatialPolygonsDataFrame object, \emph{or} of the minimum convex polygon of a set of points. Input can be a set of coordinates or a polygon.
...
areaFromPointsOrPoly <- function(x) {
	...
	if (inherits(x, 'Spatial')) {
		...
		stop('"x" must be a Spatila* object.')
	}
