...
#'	\item \code{lccCONUS} CRS for Lambert conformal conic for the contiguous United States (\code{+proj=lcc +lat_1=33 +lat_2=45 +lat_0=39 +lon_0=-96 +x_0=0 +y_0=0 +ellps=GRS80 +datum=NAD83 +units=m no_defs}).
#'	\item \code{lccEp} CRS for Lambert conformal conic for Europe (\code{+proj=lcc +lat_1=43 +lat_2=62 +lat_0=30 +lon_0=10 +x_0=0 +y_0=0 +ellps=intl +units=m no_defs}).
#'	\item \code{lccNA} CRS for Lambert conformal conic for North America (\code{+proj=lcc +lat_1=20 +lat_2=60 +lat_0=40 +lon_0=-96 +x_0=0 +y_0=0 +ellps=GRS80 +datum=NAD83 +units=m no_defs}).
#'	\item \code{lccNAsia} CRS for Lambert conformal conic for North Asia (\code{+proj=lcc +lat_1=15 +lat_2=65 +lat_0=30 +lon_0=95 +x_0=0 +y_0=0 +ellps=WGS84 +datum=WGS84 +units=m no_defs}).
#'	\item \code{lccSA} CRS for Lambert conformal conic for South America (\code{+proj=lcc +lat_1=-5 +lat_2=-42 +lat_0=-32 +lon_0=-60 +x_0=0 +y_0=0 +ellps=aust_SA +units=m no_defs}).
#'	\item \code{lccSAsia} CRS for Lambert conformal conic for South Asia (\code{+proj=lcc +lat_1=7 +lat_2=-32 +lat_0=-15 +lon_0=125 +x_0=0 +y_0=0 +ellps=WGS84 +datum=WGS84 +units=m no_defs}).
#'	\item \code{laeaN} CRS for Lambert azimuthal equal area for the North Pole (\code{+proj=laea +lat_0=90 +lon_0=0 +x_0=0 +y_0=0 +ellps=WGS84 +datum=WGS84 +units=m no_defs}).
#'	\item \code{laeaS} CRS for Lambert azimuthal equal area for the South Pole (\code{+proj=laea +lat_0=-90 +lon_0=0 +x_0=0 +y_0=0 +ellps=WGS84 +datum=WGS84 +units=m no_defs}).
