...
#' @return Numeric.
#' @seealso \code{\link[stats]{predict}} from the stats package, \code{\link[dismo]{predict}} from the dismmo package, \code{\link[raster]{predict}} fromm the raster package
#' @examples
#' 
#' @export
